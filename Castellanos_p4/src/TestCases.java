...
class TestCases {
    ...
    public void creatingTaskItemFailsWithInvalidDueDate() {
        ...
        assertEquals(-1, App.inputCheckDate("20201-10-25"));
    }
    @Test
    public void creatingTaskItemFailsWithInvalidTitle(){
        TaskItem item=new TaskItem();
        assertEquals(-1, App.inputCheckTitle(""));
    }
    @Test
    public void creatingTaskItemSucceedsWithValidDueDate(){
        TaskItem item=new TaskItem();
        assertEquals(1, App.inputCheckDate("2020-10-24"));
    }
    @Test
    public void creatingTaskItemSucceedsWithValidTitle(){
        TaskItem item=new TaskItem();
        assertEquals(1, App.inputCheckTitle("Task1"));
    }
    @Test
    ...
    public void completingTaskItemFailsWithInvalidIndex(){
        ...
        item.setCompleted("");
        list.addItem(item);
        assertEquals(-1,App.warning(1, list.getSize()));
    }
    @Test
    ...
    public void editingTaskItemDescriptionFailsWithInvalidIndex(){
        ...
        item.setCompleted("");
        list.addItem(item);
        assertEquals(-1,App.warning(4, list.getSize()));
    }
    @Test
